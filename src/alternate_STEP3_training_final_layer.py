...
trainDataset = EmbedingDataset(embeddings_path='data/features', labels_path="/home/eve/Desktop/papier_aymen/sample_dataset/Label_slides.xlsx", split='train')
traindataloader = torch.utils.data.DataLoader(trainDataset, batch_size=12, shuffle=True)

valDataset = EmbedingDataset(embeddings_path='data/features', labels_path="/home/eve/Desktop/papier_aymen/sample_dataset/Label_slides.xlsx", split='test')
...
for epoch in range(100):  # number of epochs
    ...
    with torch.no_grad():
        ...
        if cumulative_loss < min_cumulative_loss:
            ...
            torch.save(last_layer.state_dict(), f'data/models/last_layer_best_{epoch}.pth')
