...
#from fairscale.nn import checkpoint_wrapper, wrap  !!! Eve commented out this line, as it is not used in the code
...
class Decoder(nn.Module):
    ...
    def build_decoder_layer(
        ...
        #if args.fsdp:
        #    layer = wrap(layer)
        # Eve commented out the above lines, as they are not used in the code
        return layer
